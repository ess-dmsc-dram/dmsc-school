...
Model-dependent analysis involves the development of a mathematical model that can replicate the experimentally observed dataset.
This mathematical model usually has parameters that reflect physical properties of the experimental system.
These parameters are varied to optimise the model, using an optimisation algorithm, with respect to the experimental data, i.e., to get the best agreement between the data generated by the model and the experimental dataset.
