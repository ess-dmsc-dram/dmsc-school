...
class Powder_Quiz(Quiz):
    ...
    def question_1(self, answer=None):
        ...
        feedback = {"A": "No, that sample would be too large, while its very likely the "
    ...
    def question_2(self, answer=None):
        ...
        required_parameters = dict(sample_radius=0.005, l_min=2.5, l_max=2.501,
                                   sample_choice='"no_sample"', n_pulses=1)
    ...
    def question_3(self, answer=None):
        ...
        self.insert_value(answer, 2.715,
    ...
    def question_4(self, answer=None):
        ...
        feedback = {"A": "No, this would result in insufficient wavelength resolution for powder diffraction.",
    ...
    def question_5(self, answer=None):
        ...
        feedback = {"A": "No, even though that would work, we would not be utilizing the advantage of our pulsed source ",
    ...
    def question_6(self, answer=None):
        ...
        feedback = {"A": "No, the feeder starts inside the monolith where there is no room for a chopper.",
    ...
    def question_7(self, answer=None):
        ...
        if chopper_index < feeder_index:
            print_box("The DiskChopper was inserted before the feeder, this won't work!", False)
            return

        if chopper_index > expanding_index:
            print_box("The DiskChopper was inserted after the expanding section, this is not quite right", False)
            return

        msg = "The DiskChopper was added at the right point in the component sequence and with correct parameters!"
        required_pars = dict(yheight=0.05, radius=0.35, nu="frequency_multiplier*14.0",
                             nslit=1.0, delay="delay", theta_0=7.0)
    ...
    def question_9(self, answer=None):
        ...
        self.insert_value(answer, 0.4665176401,
                          feedback_correct=success_msg,
                          feedback_below=below_msg, feedback_above=above_msg,
                          tolerance_factor=0.15)
    ...
    def question_10(self, answer=None):
        ...
        required_parameters = dict(frequency_multiplier=3,
                                   l_min=0.5, l_max=4.0, detector_height=1.5,
                                   sample_radius=0.005, sample_height=0.02,
                                   sample_choice='"sample_Si"', n_pulses=1)
    ...
    def question_11(self, answer=None):
        ...
        feedback = {"A": "No, this instrument does not analyse the neutron energy after scattering, it assumes elastic scattering.",
